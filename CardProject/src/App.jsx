...
function App() {
  ...
  return (
   ...
   {jobOpenings.map(function(elem){
    return <Card CompanyName={elem.companyName} Logo={elem.brandLogo} Dp={elem.datePosted} role={elem.post} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} location={elem.location}  />
   })}
